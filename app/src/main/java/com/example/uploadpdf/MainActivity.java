...
public class MainActivity extends AppCompatActivity {
    ...
    // Server URL.
    public static final String PDF_UPLOAD_HTTP_URL = "http://paytmpay001.dx.am/api/raeces/uploadPdf.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SelectButton =  findViewById(R.id.Button_Select_PDF_ID);
        UploadButton =  findViewById(R.id.Button_Upload_PDF_ID);
        PdfNameEditText = findViewById(R.id.PDF_Name_EditText_ID);
    ...
    public void PdfUploadFunction() {
        ...
        PdfPathHolder = FilePath.getPath(MainActivity.this,uri);
